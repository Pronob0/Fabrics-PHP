...
<?php
	...
	if (isset($_POST['submit'])) {
		...
		mysqli_query($con, "INSERT INTO order_details (user_id,cart_id,product_id,product_name, quantity, rate, total,name, mobile, date, address,bkash) VALUES('$user_id','$cart_id','$product_id','$product_name','$prod_qty','$prod_rate','$total','$name','$mobile','$date','$address','$bkash') ");
